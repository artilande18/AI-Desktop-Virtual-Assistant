...
# text Lable 
text_lable = Label(frame, text="AI Assistent", font=("comic Sans ms",14, "bold"), bg="#356696")
text_lable.grid(row=0, column=0, padx=20, pady=10)

# Image
image =ImageTk.PhotoImage(Image.open("Images/AIassistent.png"))
...
entry.place(x=100, y=500, width=350, height=40)
